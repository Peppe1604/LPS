...
Il comando rem calcola il resto della divisione tra due operandi. Può essere utilizzato per ottenere direttamente il resto senza dover ricorrere ai registri speciali hi e lo come nel caso di div .
...
Calcola il resto della divisione tra il valore del secondo operando (dividendo) e un numero immediato a 32 bit , salvando il risultato nel primo operando.
...
- Potrebbe causare un'eccezione o un errore durante l'esecuzione.
